...
import com.bg.baseutillib.tool.constant.TimeConstants;
...
public final class TimeUtil {
    ...
    public static final String DEFAULT_PATTERN1 = "yyyy-MM-dd HH:mm";
     ...
     * @return unit时间戳
     */
    public static long getTimeSpan1(String time0, String time1, @TimeConstants.Unit int unit) {
        return getTimeSpan1(time0, time1, unit, DEFAULT_PATTERN);
    }
     ...
     * @return unit时间戳
     */
    public static long getTimeSpan1(String time0, String time1, @TimeConstants.Unit int unit, String pattern) {
        return millis2TimeSpan(string2Millis(time0, pattern) - string2Millis(time1, pattern), unit);
    }
    ...
    public static Date getBeforeTimeDate() {
    ...
    public static String getWeeks(Date date) {
        String src = new SimpleDateFormat("EEEE", Locale.getDefault()).format(date);
        return src.substring(src.length() - 1, src.length());
    }
     ...
     * @return
     */
    public static int[] getDateCount(long date2, long date1) {
        int[] list = new int[4];
        long l = date2 - date1;
    ...
    public static String formatTime(String t) {
        String time = "";
        try {
            Date date = TimeUtil.string2Date(t);
            time = TimeUtil.date2String(date, DEFAULT_PATTERN1);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return time;
     ...
     * @return
     */
    public static String formatTimeDay(String t) {
        String time = "";
        try {
            Date date = TimeUtil.string2Date(t);
            time = TimeUtil.date2String(date, DEFAULT_PATTERN2);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return time;
     ...
     * @return
     */
    public static String formatTimeDay1(String t) {
        String time = "";
        try {
            Date date = TimeUtil.string2Date(t);
            time = TimeUtil.date2String(date, DEFAULT_PATTERN3);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return time;
     ...
     * @return
     */
    public static String formatTimeDay2(String t, String pattern) {
        String time = "";
        try {
            Date date = TimeUtil.string2Date(t);
            time = TimeUtil.date2String(date, pattern);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return time;
